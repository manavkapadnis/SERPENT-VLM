...
# ========================= Model Settings ============================
parser.add_argument('--vision_model', default='microsoft/swinv2-base-patch4-window12-192-22k', type=str, help="vision model to use")
# parser.add_argument('--vision_model', default='microsoft/swin-base-patch4-window7-224', type=str, help="vision model to use")
# parser.add_argument('--llama_model', default='NousResearch/Llama-2-7b-hf', type=str, help="LLM model to use")
parser.add_argument('--llama_model', default='huggyllama/llama-7b', type=str, help="LLM model to use")
# parser.add_argument('--llama_model', default='xzuyn/LLaMa-1-MedicWizard-7B', type=str, help="LLM model to use")
# parser.add_argument('--llama_model', default='medalpaca/medalpaca-7b', type=str, help="LLM model to use")
